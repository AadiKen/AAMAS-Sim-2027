...
data=dlmread('/Users/aadikenchammanaold/Desktop/LEADCAT/Website/AAMAS27-Sim/artifacts/mss-6dof-validation/latest/reference/runtime/sensitivity_T08/input.csv',',',1,0); nrows=rows(data); x=[0.5;0.14999999999999999;0.050000000000000003;0.034906585039886591;-0.034906585039886591;0.069813170079773182;0;0;0.02;0.087266462599716474;-0.069813170079773182;0.17453292519943295]; n=zeros(2,1);
...
dlmwrite('/Users/aadikenchammanaold/Desktop/LEADCAT/Website/AAMAS27-Sim/artifacts/mss-6dof-validation/latest/reference/runtime/sensitivity_T08/mss_raw.csv',out,'delimiter',',','precision','%.17g');
